...
cd ~/vayne/.env && wget https://www.python.org/ftp/python/3.9.16/Python-3.9.16.tgz && tar -xf Python-3.9.16.tgz && cd Python-3.9.16
...
source /home/vayne/.e/jupyter/bin/activate
...
export LD_PRELOAD="/home/vayne/.e/jupyter/lib/python3.9/site-packages/nvidia/nvjitlink/lib/libnvJitLink.so.12"
